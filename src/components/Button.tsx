...
export const Button: React.FC<props> = ({children, primary, cancel, clearSearch, login, signup, cancelSignup, logout, disabled, onClick}, props) => {
  return (
    <>
      ...
      {logout && <Logout onClick={onClick}>{children}</Logout>}
    </>
  )
}